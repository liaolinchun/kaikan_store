(my["webpackJsonp"] = my["webpackJsonp"] || []).push([["pages/order/base/createOrder"],{
...
var _createOrder = _interopRequireDefault(__webpack_require__(/*! ./pages/order/base/createOrder.vue */ 34));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _createOrder_vue_vue_type_template_id_1b181528___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./createOrder.vue?vue&type=template&id=1b181528& */ 35);
/* harmony import */ var _createOrder_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./createOrder.vue?vue&type=script&lang=js& */ 37);
...
/* harmony import */ var _createOrder_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./createOrder.vue?vue&type=style&index=0&lang=scss& */ 39);
...

{
  ...
  onLoad: function onLoad(option) {var _this = this;
    ...
    this.goodsInfo.forEach(function (goods) {
      ...
      _this.sum = goods.num * goods.price_one;
      if (goods.game == '拍卖') {
        _this.game = true;
        _this.sum = goods.kanMoney * goods.num;
      }
    ...
    submit: function submit() {
      if (this.game) {//拍卖
        ...
        if (this.key) {//通过购物车结算
          ...
          var all_price = parseInt(this.sum); //总价
          uni.showLoading({
            title: '订单生成中...' },
          500);
...
//# sourceMappingURL=../../../../.sourcemap/mp-alipay/pages/order/base/createOrder.js.map