...
/* harmony import */ var _order_vue_vue_type_template_id_952a356c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./order.vue?vue&type=template&id=952a356c& */ 147);
...
/* harmony import */ var _order_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./order.vue?vue&type=style&index=0&lang=scss& */ 151);
  ...
  methods: {
    ...
    toComment: function toComment(item) {//精确跳转
      if (item.state_name == '已完成') {
        ...
        return;
      } else if (item.state_name == '待付款') {//直接付款
        this.order_num = item.order_num;
        this.sum = item.all_price;
        this.showPay = true;
