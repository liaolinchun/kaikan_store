(my["webpackJsonp"] = my["webpackJsonp"] || []).push([["pages/game/index"],{
...
var _index = _interopRequireDefault(__webpack_require__(/*! ./pages/game/index.vue */ 186));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _index_vue_vue_type_template_id_361b47f0___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=361b47f0& */ 187);
...
//
//
var timer;var share = function share() {return __webpack_require__.e(/*! import() | pages/game/share */ "pages/game/share").then(__webpack_require__.bind(null, /*! ./share.vue */ 277));};var _default = { data: function data() {return { headerShow: false, goods_id: '', //商品id
      ...
      help: [], //朋友帮砍
      bottomPrice: '', //最低的价格
      remark: '注: 请在游戏活动时间结束之前进行购买' };}, onLoad: function onLoad(option) {var _this = this;try {uni.showToast({ icon: "loading", title: "数据获取中" });if (option.scanCode) {//扫码进入
        this.headerShow = false;this.isFriend = true;var codeData = JSON.parse(option.scanCode);this.kan_id = codeData.k;this.gameOverShow = false;this.request({ //扫码后发起请求
          url: _interface.default.friend_kan, method: 'POST', data: { kan_id: codeData.k }, success: function success(res) {if (res.error_code == 1) {uni.showToast({ title: res.data, icon: 'none' });setTimeout(function () {uni.navigateTo({ url: '../public/login' });}, 1000);} else
            if (res.error_code == 4) {//游戏已经结束
      ...
      this.request({
        ...
        success: function success(res) {
          ...
          if (res.error_code == 5) {//已经玩过此游戏,不能重复玩!
            ...
            _this2.help_Arr();
            _this2.open();
            if (res.on_price <= _this2.bottomPrice) {//到达最低价
      ...
      this.request({
        ...
        success: function success(res) {
          ...
          if (res.error_code == 0) {
            ...
            _this4.open();
            if (res.on_price <= _this4.bottomPrice) {//到达最低价
...
//# sourceMappingURL=../../../.sourcemap/mp-alipay/pages/game/index.js.map