(my["webpackJsonp"] = my["webpackJsonp"] || []).push([["pages/public/register"],{
...
/* harmony import */ var _register_vue_vue_type_template_id_0e95cf06___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./register.vue?vue&type=template&id=0e95cf06& */ 115);
...

{
  ...
  methods: {
    ...
    toRegister: function () {var _toRegister = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var _this2 = this;var mobile, verify, password;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                ...
                //获取验证码	
                this.request({
                  url: _interface.default.zhuce, //验证 验证码
                  method: "POST",
                  data: {
                    code: this.verify },

                  success: function success(res) {//注册
                    if (res.error_code === 0) {
                      _this2.request({
...
//# sourceMappingURL=../../../.sourcemap/mp-alipay/pages/public/register.js.map