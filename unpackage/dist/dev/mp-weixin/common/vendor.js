...
var store = new _vuex.default.Store({
  ...
  mutations: {
    login: function login(state, provider) {//登录
      state.hasLogin = true;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/jifen/jifen": { "navigationBarTitleText": "积分商城", "enablePullDownRefresh": true, "onReachBottomDistance": 0 }, "pages/home/home": { "navigationBarTitleText": "开砍商城", "enablePullDownRefresh": true, "onReachBottomDistance": 0 }, "pages/order/base/createOrder": { "navigationBarTitleText": "提交订单" }, "pages/pay/toPay": { "navigationBarTitleText": "订单详情", "navigationBarBackgroundColor": "#F7F7F7" }, "pages/pay/endOrder": { "navigationBarTitleText": "订单详情", "navigationBarBackgroundColor": "#F7F7F7" }, "pages/category/category": { "navigationBarTitleText": "分类", "enablePullDownRefresh": true, "onReachBottomDistance": 0 }, "pages/category/toCategory": { "navigationBarTitleText": "跳转分类", "enablePullDownRefresh": true, "onReachBottomDistance": 0 }, "pages/user/user": { "enablePullDownRefresh": true, "onReachBottomDistance": 0, "navigationBarTitleText": "我的" }, "pages/user/base/gameOrder": { "navigationBarTitleText": "我的砍价" }, "pages/set/set": { "navigationBarTitleText": "设置" }, "pages/set/base/setPhone": { "navigationBarTitleText": "修改密码" }, "pages/public/login": { "navigationBarTitleText": "", "navigationStyle": "custom" }, "pages/public/register": { "navigationBarTitleText": "", "navigationStyle": "custom" }, "pages/good/goods": { "navigationBarTitleText": "商品", "navigationBarTextStyle": "black" }, "pages/good/base/ratings": { "navigationBarTitleText": "商品评论" }, "pages/cart/cart": { "navigationBarTitleText": "购物车" }, "pages/order/order": { "navigationBarTitleText": "我的订单", "navigationBarBackgroundColor": "#F7F7F7" }, "pages/order/base/afterSale": { "navigationBarTitleText": "申请售后" }, "pages/order/base/orderComment": { "navigationBarTitleText": "发表评价", "navigationBarBackgroundColor": "#F7F7F7" }, "pages/address/address": { "navigationBarTitleText": "收货地址" }, "pages/address/addressManage": { "navigationBarTitleText": "编辑收货地址" }, "pages/game/index": { "navigationBarTitleText": "开砍" }, "packageA/pages/swop/swop": { "navigationBarTitleText": "礼品专区", "enablePullDownRefresh": true, "onReachBottomDistance": 0 }, "packageA/pages/swop/base/buyMember": { "navigationBarTitleText": "礼品卡" }, "packageA/pages/swop/base/toBuy": { "navigationBarTitleText": "购买礼品包" }, "packageA/pages/aucGoods/aucGoods": { "navigationBarTitleText": "拍卖商品" }, "packageA/pages/aucGoods/base/priceLog": { "navigationBarTitleText": "出价记录", "enablePullDownRefresh": true, "onReachBottomDistance": 0 }, "packageA/pages/aucGoods/base/laterDeal": { "navigationBarTitleText": "往期成交" }, "packageA/pages/aucGoods/base/pingJia": { "navigationBarTitleText": "评价" } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "uni-app", "navigationBarBackgroundColor": "#fff", "backgroundColor": "#fff" } };exports.default = _default;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__EA96681" };exports.default = _default;
