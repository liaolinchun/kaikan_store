...
//
//
var _default = { data: function data() {return { show_buy: false, price: 999, jifen: 0, curId: 0, page: 0, //当前所在页
      img: "../../../static/img/bg_liwu.jpg", //默认背景图
      img_on: "../../../static/img/bg_liwu_on.jpg", //选中背景图
      iconList: [{ "id": "1", "jifen": "1500", "desc": "15元礼品包", "price": "12", "old_price": "15元" }, { "id": "2", "jifen": "2730", "desc": "39元礼品包", "price": "39" }, { "id": "3", "jifen": "7920", "desc": "99元礼品包", "price": "99" }, { "id": "4", "jifen": "17910", "desc": "199元礼品包", "price": "199" }, { "id": "5", "jifen": "29900", "desc": "299元礼品包", "price": "299" }, { "id": "6",
        "jifen": "59900",
        "desc": "599元礼品包",
        "price": "569",
        "old_price": "599元" },
    ...
    weixinPay: function weixinPay() {var _this = this;
      ...
      uni.login({
        success: function success(e) {
          console.log(e.code);
          uni.request({
            url: _interface.default.jifen_buy,
            method: 'POST',
            data: {
              code: e.code, // code 换取 openid 和 session_key 等信息
              price: _this.price, //支付价格
              jifen: _this.jifen //所获积分
            },
...
//# sourceMappingURL=../../../../../.sourcemap/mp-weixin/packageA/pages/swop/base/toBuy.js.map