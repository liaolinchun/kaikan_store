<template>
	<view>
		<!--倒计时付款-->
		<view class="payTime" v-if="!hideTime">
			<view class="pay">
				<image src="../../../static/img/tabBar/user.png"></image>
				<text>等待付款</text>
			</view>
			<view class="time">
				<text>剩余:</text>
		...
		<view class="order-info">
			<view class="top">
				<view>
					...
					<text class="type plus">{{goodsInfo.order_num}}</text>
					<text class="type copy">复制</text>
				</view>
				<view>
					<text>下单时间 :</text>
					<text class="plus">{{goodsInfo.time}}</text>
				</view>
			</view>
			<view class="bot">
				<view class="box1">
					<text>商品总额 :</text>
					<text class="plus">￥{{goodsInfo.all_price}}</text>
				</view>
				<view class="box2">
					<text>运费 :</text>
					<text class="plus">￥{{goodsInfo.detail[0].you}}</text>
				</view>
				<view class="box3">
					<view></view>
					<view>
						<text class="bb2" v-if="hideTime">已付款:</text>
						<text class="bb1" v-if="!hideTime">取消订单</text>
						<text class="bb2" v-if="!hideTime">需付款</text>
						<text class="bb3">￥{{goodsInfo.all_price}}</text>
					</view>
				</view>
			</view>
		</view>
